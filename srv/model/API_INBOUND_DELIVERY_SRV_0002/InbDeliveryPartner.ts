  ...
  implements InbDeliveryPartnerType<T>
{
   ...
   * Maximum length: 10.
   */
  declare contactPerson: DeserializedType<T, 'Edm.String'>;
  /**
   * Customer.
   * Maximum length: 10.
   */
   ...
   * Maximum length: 8.
   */
  declare personnel: DeserializedType<T, 'Edm.String'>;
  /**
   * SD Document.
   * Maximum length: 10.
   */
  declare sdDocument: DeserializedType<T, 'Edm.String'>;
  /**
   * Item.
   * Maximum length: 6.
   */
  declare sdDocumentItem: DeserializedType<T, 'Edm.String'>;
  /**
   * Supplier.
   * Maximum length: 10.
   */
   ...
   */
  declare toAddress?: InbDeliveryAddress<T> | null;
