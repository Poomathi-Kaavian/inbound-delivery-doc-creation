...
> implements EntityApi<MaintenanceItemObjList<DeSerializersT>, DeSerializersT>
{
  ...
  private _schema?: {
    ...
    SERIAL_NUMBER: OrderableEdmTypeField<
      ...
      true
    >;
    MANUFACTURER_SERIAL_NUMBER: OrderableEdmTypeField<
      MaintenanceItemObjList<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link manufacturerSerialNumber} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        MANUFACTURER_SERIAL_NUMBER: fieldBuilder.buildEdmTypeField(
