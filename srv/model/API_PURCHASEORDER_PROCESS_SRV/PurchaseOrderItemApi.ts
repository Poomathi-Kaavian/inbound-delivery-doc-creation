...
import { ValAddedSrvcMm_2Api } from './ValAddedSrvcMm_2Api';
import {
  CustomField,
...
> implements EntityApi<PurchaseOrderItem<DeSerializersT>, DeSerializersT>
{
  ...
  private navigationPropertyFields!: {
    ...
    >;
    /**
     * Static representation of the one-to-many navigation property {@link toValueAddedService2} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TO_VALUE_ADDED_SERVICE_2: Link<
      PurchaseOrderItem<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ...
      TO_VALUE_ADDED_SERVICE_2: new Link(
  ...
  private _schema?: {
    ...
    PRODUCT_CHARACTERISTIC_3: OrderableEdmTypeField<
      ...
      true
    >;
    SUB_ITEM_CATEGORY: OrderableEdmTypeField<
      PurchaseOrderItem<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    PURCHASE_ORDER_REFERENCE_TYPE: OrderableEdmTypeField<
      ...
      true
    >;
    REFERENCE_DOCUMENT_SCHEDULE_LINE: OrderableEdmTypeField<
      PurchaseOrderItem<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link subItemCategory} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        SUB_ITEM_CATEGORY: fieldBuilder.buildEdmTypeField(
          'SubItemCategory',
          'Edm.String',
          true
        ),
        ...
        /**
         * Static representation of the {@link referenceDocumentScheduleLine} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        REFERENCE_DOCUMENT_SCHEDULE_LINE: fieldBuilder.buildEdmTypeField(
